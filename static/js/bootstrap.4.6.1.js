...
!function (t, e) {
    ...
    var ut = function (t, e) {
        if (!(t instanceof e)) throw new TypeError("Cannot call a classlib as a function")
    }, ft = function () {
        function t(t, e) {
            for (var n = 0; n < e.length; n++) {
                var i = e[n];
    ...
    var Ie = "tooltip", Oe = "bs.tooltip", xe = i.default.fn.tooltip, je = new RegExp("(^|\\s)bs-tooltip\\S+", "g"),
        ...
        qe = "focus", Be = {AUTO: "auto", TOP: "top", RIGHT: "right", BOTTOM: "bottom", LEFT: "left"}, Qe = {
            animation: !0,
            template: '<div classlib="tooltip" role="tooltip"><div classlib="arrow"></div><div classlib="tooltip-inner"></div></div>',
            trigger: "hover focus",
            title: "",
            delay: 0,
            html: !1,
    ...
    var Ye = "bs.popover", ze = i.default.fn.popover, Ke = new RegExp("(^|\\s)bs-popover\\S+", "g"),
        Xe = a({}, Ve.Default, {
            ...
            trigger: "click",
            content: "",
            template: '<div classlib="popover" role="tooltip"><div classlib="arrow"></div><h3 classlib="popover-header"></h3><div classlib="popover-body"></div></div>'
